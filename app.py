...
def main():
    html_temp = """
    <div style = "background color:#20B2AA; padding:20px">
    <h1 style="color:red; text-align:center;">Used Car Price Prediction</h1>
    </div>
    """
    ...
    if option == 'About':
        html_temp_about = """
            <div style = "background color:#00FA9A; padding:10px">
            <h3 style="color:#2F4F4F; text-align:center;">About</h3></div>
            <div style = "background color:	#CD853F; padding:30px">
        ...
        html_temp_contact = """
                    <div style = "background color:#00FA9A; padding:10px">
                    <h3 style="color:	#2F4F4F; text-align:center;">Contact</h3></div>
                    <div style = "background color:#CD853F; padding:30px">
                    <p>This Model is Developed by <b>Vatsal Kansara and Sahil Bhat</b></p>
                    <p>LinkedIn(Vatsal): <a href="https://www.linkedin.com/in/vatsal-kansara-2aa5681a2/">Link</a></p>
                    <p>LinkedIn(Vatsal): <a href="https://www.linkedin.com/in/sahil-bhat-155872189/">Link</a></p>
                    <p>HAPPY CODING</p>
                    </div>"""
    ...
    html_temp_end = """
        ...
        <h3 style="color:#FFFFFF;text-align:center;" >Developed By:<b>Vatsal Kansara and Sahil Bhat</b> </h3>
        </div>
        """
